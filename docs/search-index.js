...
window.SEARCH_INDEX = [
  ...
  },
  {
    ...
    body: 'build source rust node npm cargo toolchain plugin:standalone plugin:build plugin:install ci:local bundled gate',
  },
  {
    id: 'licence',
    title: 'Licence',
    body: 'licence license proprietary source-available all rights reserved not open source redistribute derivatives music is yours royalty attribution',
  },
];
