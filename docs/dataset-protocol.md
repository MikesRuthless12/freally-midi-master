...
<!-- ROSTER-LEDGER:BEGIN -->
**1236 models** — 788 artists and 448 producers; 311 flagship, 925 standard, 0 inherited, across 28 lanes.
...
| `justin-timberlake` | Justin Timberlake | flagship | high | 3 |
...
| `blackstreet` | Blackstreet | flagship | high | 4 |
...
| `dru-hill` | Dru Hill | standard | medium | 4 |
...
| `jodeci` | Jodeci | standard | medium | 4 |
