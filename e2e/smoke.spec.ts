...
test('the View menu lists every panel', async ({ page }) => {
  ...
  // kit, stems, session, presets. The menu is built from that list, so adding a
  // panel is meant to land here — this count is the reminder to check the new
  // one actually appears rather than a number to bump.
